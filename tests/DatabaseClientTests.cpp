...
void testSaveAndQuery() {
  ...
  db.saveGame({.name = "Ada",
               .gridSize = 4,
               .moves = 80,
               .duration = 42,
               .playedAt = 1000.0});
  db.saveGame({.name = "Bob",
               .gridSize = 4,
               .moves = 60,
               .duration = 30,
               .playedAt = 2000.0});
  db.saveGame({.name = "Cara",
               .gridSize = 5,
               .moves = 99,
               .duration = 99,
               .playedAt = 3000.0});
  ...
  if (best4.has_value()) {
    ...
    expect(!best4->empty() && best4->front().duration == 30,
           "fastest 4x4 score is first");
    expect(!best4->empty() && best4->front().name == "Bob",
           "fastest 4x4 score is Bob's");
  }
